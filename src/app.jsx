...
const App = () => {
  ...
  const onFilterTextChange = ({ target: { value } }) => setTextSearch(value);

  const mappedRecipes = useMemo(
    () => recipes.filter((recipe) => !!recipe.image && recipe.difficulty),
    [recipes]
  );
    ...
    <>
      ...
      <section className="list">
        {mappedRecipes.map((recipeData, key) => {
          ...
          const showByDifficulty =
            recipeDifficulty && difficulty !== 'any'
